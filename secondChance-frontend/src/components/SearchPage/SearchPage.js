            ...
            <div className="col-md-6">
              <div className="filter-section mb-3 p-3 border rounded bg-dark text-light">
                ...
                <div className="d-flex flex-column">
                  ...
                  <select id="categorySelect" className="form-control my-1 bg-secondary text-light">
                  ...
                  <select id="conditionSelect" className="form-control my-1 bg-secondary text-light">
                    <option value="">All</option>
